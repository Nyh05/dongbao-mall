...
public class DongbaoGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\dongbao1\\msb-dongbao-mall-parent\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("nyh");
        ...
        dsc.setUrl("jdbc:mysql://192.168.32.138:3306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
